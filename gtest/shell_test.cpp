...
TEST_F(ShellTest, DisplayArguments) {
  ...
  EXPECT_EQ(expected_output, output);
//  write(saved_stdout, "Expected output:\n", strlen("Expected output:\n"));
  //write(saved_stdout, expected_output.c_str(), expected_output.length());

  //write(saved_stdout, "\nOutput:\n", strlen("\nOutput:\n"));
  //write(saved_stdout, output.c_str(), output.length());
...
//  write(saved_stdout, "\nOutput:\n", strlen("\nOutput:\n"));
 // write(saved_stdout, firstLine.c_str(), firstLine.length());
